"""Scan ch3-2.json for answer-leak patterns in incorrect choices."""
import json, re
...
for q in data["questions"]:
    ...
    for i, c in enumerate(q["choices"]):
        ...
        if not is_correct:
            ...
            # Self-refuting structure: first sentence wrong, second sentence corrects it
            if "。" in txt:
                sentences = txt.split("。")
                if len(sentences) >= 3:
...
print(f"=== Answer-leak scan for ch3-2 ===")
