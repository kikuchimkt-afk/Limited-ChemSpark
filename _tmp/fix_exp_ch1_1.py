"""Fix ch1-1.json explanation display fields only.
question/choices are already fixed by _audit_display.py --apply.
explanation needs separate handling because _audit_display excludes it.
"""
...
print("Fixing explanation display fields...")
exp_changes = 0
